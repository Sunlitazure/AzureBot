 ...
 * @author Peter Abeles
 */
public class SelectTracker<T extends ImageBase> extends JPanel
	 ...
	 */
	public SelectTracker( TrackerObjectQuad<T> tracker,
...
//				FactoryTrackerObjectQuad.meanShiftLikelihood(30,5,255, MeanShiftLikelihoodType.HISTOGRAM,colorType);
		...
		SelectTracker app = new SelectTracker(tracker,640,480);
